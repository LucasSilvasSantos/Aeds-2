...
public class heapsort {
    ...
    /* ---------- Heapsort (chave: dataAbertura; empate: nome) ---------- */

    static int compararData(Data a, Data b) {
        if (a.getAno() != b.getAno()) return a.getAno() - b.getAno();
    ...
    static int comparar(Restaurante a, Restaurante b) {
        comparacoes++;
        int cmp = compararData(a.getDataAbertura(), b.getDataAbertura());
        if (cmp != 0) return cmp;
        comparacoes++;
